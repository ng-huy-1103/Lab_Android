        ...
        <>
            { props.expanded &&
                <Nav className={"flex-column my-sidebar my-sidebar-expanded"}>
                    ...
                    <Nav.Item><Nav.Link as={Link} to="/users"><FontAwesomeIcon icon={faUsers} />{' '}Пользователь</Nav.Link></Nav.Item>
                    <Nav.Item><Nav.Link as={Link} to="/museums"><FontAwesomeIcon icon={faUniversity} />{' '}Музей</Nav.Link></Nav.Item>
                    <Nav.Item><Nav.Link as={Link} to="/paintings"><FontAwesomeIcon icon={faImage} />{' '}Картина</Nav.Link></Nav.Item>
                </Nav>
            }
            { !props.expanded &&
